...
<s:form action="employee_update" method="post" id="saveForm" theme="simple">
...
<tr>
	...
	<td>密码：</td>
	<td><s:password name="password" value="%{model.password}" showPassword="true"></s:password>
</tr>

<tr>
<td>所属部门：</td>
<td><s:select name="department.did" value="%{model.department.did}" list="list" listKey="did" listValue="dname" headerKey="0" headerValue="---请选择---" theme="simple"/></td>
<td>编号:</td>
