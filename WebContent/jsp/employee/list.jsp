...
<td align="center"><a href="${pageContext.request.contextPath }/employee_edit.action?eid=<s:property value="#e.eid"/>"><img src="${pageContext.request.contextPath}/images/bj.png"/></a></td>
<td align="center"><a href="${pageContext.request.contextPath }/employee_delete.action?eid=<s:property value="#e.eid"/>"><img src="${pageContext.request.contextPath}/images/delete.png" width="25" height="25"/></a></td>
</tr>
</tbody>
</s:iterator>
</table>
...
<td align="right">
   ...
   <span>总共<s:property value="totalCount"/>条记录</span>&nbsp;&nbsp;
   <span>
