...
<s:form action="employee_save" method="post" id="saveForm" theme="simple">
...
<tr>
<td>所属部门：</td>
<td><s:select name="department.did" list="list" listKey="did" listValue="dname" headerKey="0" headerValue="---请选择---" theme="simple"/></td>
<td>编号:</td>
